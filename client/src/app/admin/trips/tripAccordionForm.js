...
export function TripAccordionForm({
  form,
  setForm,
  editingId,
  setEditingId,
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-3 bg-surface text-root-primary">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div className="flex flex-col">
              <label className="mb-1 text-sm font-medium text-white/80">Trip Name</label>
              <input
            ...
            {/* Price */}
            <div className="flex flex-col">
              <label className="mb-1 text-sm font-medium text-white/80">Price</label>
              <input
                type="number"
                className="px-3 py-2 rounded input-surface text-white"
                value={form.price}
            ...
            {/* Capacity */}
            <div className="flex flex-col">
              <label className="mb-1 text-sm font-medium text-white/80">Capacity</label>
              <input
                type="number"
                className="px-3 py-2 rounded input-surface text-white"
                value={form.capacity}
